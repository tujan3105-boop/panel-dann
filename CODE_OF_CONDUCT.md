...
## Enforcement
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainers via the channels in `SUPPORT.md`. All complaints will be reviewed and investigated promptly and fairly.
...
To view the original text, see `https://www.contributor-covenant.org/version/2/1/code_of_conduct/`.
